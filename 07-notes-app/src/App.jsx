  ...
  return (
    <div className='h-screen lg:flex bg-black text-white'>
      ...
      <form onSubmit={(e) => { SubmitHandler(e) }} className='flex gap-4 lg:w-1/2 p-10 flex-col items-start' >
        ...
        <input type="text" placeholder='Enter The Title Of Note' value={title} onChange={(e) => { setTitle(e.target.value) }}
          className='px-5 w-full font-medium py-2 border-2 outline-none rounded ' />

        {/* description input */}

        <textarea type="text" placeholder='Enter your description' value={description} onChange={(e) => { setdescription(e.target.value) }}
